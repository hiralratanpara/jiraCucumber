...
describe("wsi ship to store ", () => {
  ...
  it("Search for a city within 25 miles were product is available for pickup", () => {
    ...
    cy.get(
      "#_ev_5 > div > div.store-pickup-selector-container > p.pickup-store-list-label.initialStoreListLabel.store-search-result-header"
    ).should("have.text", "Find & Pick a Store");
